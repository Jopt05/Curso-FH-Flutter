...
import 'package:twelve_cinemapedia/infrastructure/models/moviedb/movie_moviedb.dart';

class MovieMapper {
  // Nos permite crear una película basado en un objeto que recibamos de IMDB, TheMovieDB
